...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.setdefault('DJANGO_DATABASE_HOST', 'localhost'),                      # Set to empty string for localhost. Not used with sqlite3.
...
ELASTICSEARCH_HOSTS = [
    {'host': os.environ.setdefault('DJANGO_ELASTICSEARCH_HOST', 'localhost'), 'port': ELASTICSEARCH_HTTP_PORT}
]
