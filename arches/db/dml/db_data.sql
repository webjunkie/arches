...
INSERT INTO functions(functionid, modulename, classname, functiontype, name, description, defaultconfig, component)
    VALUES ('60000000-0000-0000-0000-000000000002', 'required_nodes.py', 'RequiredNodesFunction', 'validation', 'Required Nodes Function', 'A function that requires that specified nodes are populated', '{"required_nodes":"{}"}', 'views/components/functions/required-nodes');
